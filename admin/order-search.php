...
<div class="main-content">
    ...
    <div class="wrapper">
        ...
        <table class="tbl-full">
            ...
            $sql = "SELECT * FROM don_hang WHERE san_pham LIKE '%$search%' ORDER BY id DESC"; //Hiển thị đơn hàng gần nhất
            //Chạy SQL
            ...
            <?php
                ...
                //Không có đơn hàng
                echo "<tr><td colspan='12' class='error'>Không tìm thấy đơn hàng.</td></tr>
                ";
            }
            ?>
        </table>
    ...
    <div class="wrapper">
        ...
        <table class="tbl-full">
            ...
            $sql = "SELECT * FROM don_huy WHERE san_pham LIKE '%$search%' ORDER BY id DESC"; //Hiển thị đơn hàng hủy gần nhất
            //Chạy SQL
            $res = mysqli_query($conn, $sql);
            //Đếm số dòng
            $count = mysqli_num_rows($res);
            ...
            <?php
                ...
                echo "<tr><td colspan='12' class='error'>Không tìm thấy đơn hàng hủy.</td></tr>";
            }
            ?>
        </table>
    </div>
