...
<div class="main-content">
    ...
    <div class="wrapper">
        ...
        <table class="tbl-full">
            ...
            $sql = "SELECT * FROM lien_he WHERE khach_ten LIKE '%$search%' ORDER BY id DESC"; //Hiển thị phản hồi gần nhât
            //Chạy SQL
            ...
            <?php
                ...
                //Không có phản hồi
                echo "<tr><td colspan='12' class='error'>Không tìm thấy phản hồi.</td></tr>";
            }
            ?>
        </table>
    </div>
